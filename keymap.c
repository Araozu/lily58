...
//*/------------------------------------------------------------------------------------------/**/                             /**/--------------------------------------------------------------------------------------------
/**/       KC_MINS,          KC_A,         KC_O,          KC_E,          KC_I,       KC_SCLN, /**/                             /**/          KC_J,          KC_R,          KC_T,          KC_N,          KC_S,       KC_LBRC,
//*/------------------------------------------------------------------------------------------/****************/ /****************/--------------------------------------------------------------------------------------------
/**/       KC_RBRC,       LWINMOD,      LALTMOD,       LSFTMOD,       LCTRMOD,     LALTGRMOD,       KC_LBRC,/**/ /**/      KC_RBRC,     RALTGRMOD,       RCTRMOD,       RSFTMOD,       RALTMOD,       RWINMOD, RALT(KC_BSLS),
//*/----------------------------------------/**/------------------------------------------------------------/**/ /**/------------------------------------------------------------/**/------------------------------------------
...
//*/----------------------------------------/**/------------------------------------------------------------/**/ /**/------------------------------------------------------------/**/------------------------------------------
                                            /**/       XXXXXXX,       KC_LALT,      MO(_NUM),        KC_SPC,/**/ /**/       KC_BSPC,LT(_SYM,KC_ENT),       KC_RALT,       XXXXXXX/**/
                                            ////------------------------------------------------------------/**/ /**/------------------------------------------------------------/**/
),
 ...
 *                                                  |------+------+------+------+------+------|       |                  |       |------+------+------+------+------+------|
 *                                                  |LCTRL |  G+1 |  G+2 |  G+3 |  G+4 |  G+5 |-------|                  |-------|      |PrevM |VolUp |VolDow|NextM |Intro |
 *                                                  `-----------------------------------------/       /                   \      \-----------------------------------------'
 *                                                                    |      | LALT |LOWER | /Space  /                     \Bksp  \  |RAISE  | RALT |      |
 *                                                                    |      |      |      |/       /                       \      \ |Intro  |      |      |
 *                                                                    '----------------------------'                         '------''---------------------'
...
//*/------------------------------------------------------------------------------------------/****************/ /****************/--------------------------------------------------------------------------------------------
/**/      KC_LCTL,       G(KC_1),       G(KC_2),       G(KC_3),       G(KC_4),       G(KC_5),       XXXXXXX,/**/ /**/      XXXXXXX,       XXXXXXX,KC_MEDIA_PREV_TRACK,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_MEDIA_NEXT_TRACK,  KC_ENT,
//*/----------------------------------------/**/------------------------------------------------------------/**/ /**/------------------------------------------------------------------/**/------------------------------------------
                                            /**/       XXXXXXX,       KC_LALT,       _______,        KC_SPC,/**/ /**/      KC_BSPC,LT(_FUN, KC_ENT),          KC_RALT,          XXXXXXX/**/
                                            ////------------------------------------------------------------/**/ /**/------------------------------------------------------------------/**/
),
...
/**/       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,/**/                             /**/        XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,
//*/------------------------------------------------------------------------------------------/--/                             /--/-----------------------------------------------------------------------------------------
/**/        KC_TAB,       KC_EXLM,         KC_AT,       KC_HASH,        KC_DLR,       KC_PERC,/**/                             /**/        KC_AMPR,       KC_ASTR,       KC_LPRN,       KC_CIRC,       KC_RPRN,        KC_ESC,
//*/------------------------------------------------------------------------------------------/--/                             /--/-----------------------------------------------------------------------------------------
/**/       KC_LSFT,    RALT(KC_1),    RALT(KC_4),       KC_NUBS,    S(KC_NUBS),        KC_EQL,/**/                             /**/        XXXXXXX,      KC_QUOTE,       KC_BSLS,KC_DOUBLE_QUOTE,      KC_PIPE,       KC_LGUI,
//*/------------------------------------------------------------------------------------------/*****************/ /**************/------------------------------------------------------------------------------------------
/**/       KC_LCTL,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,/**/ /**/     XXXXXXX,        XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,        KC_ENT,
//*/----------------------------------------/**/      ---------      ---------      -------------------------/**/ /**/---------------------------------------------------------/**/------------------------------------------
                                            /**/        XXXXXXX,       KC_LALT,      MO(_FUN),        KC_SPC,/**/ /**/     KC_BSPC,       _______,       KC_RALT,       XXXXXXX/**/
                                            ////-------------------------------------------------------------/**/ /**/---------------------------------------------------- ----/**/
),
...
//*/------------------------------------------------------------------------------------------/*****************/ /***************/------------------------------------------------------------------------------------------
/**/       KC_LCTL,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,      DF(_QWE),       XXXXXXX,/**/ /**/     XXXXXXX,      DF(_DVO),       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,        KC_ENT,
//*/----------------------------------------/**/      ---------      ---------      -------------------------/**/ /**/---------------------------------------------------------/**/------------------------------------------
                                            /**/        XXXXXXX,       KC_LALT,       _______,        KC_SPC,/**/ /**/      KC_ENT,       _______,       KC_RALT,       XXXXXXX/**/
                                            ////-------------------------------------------------------------/**/ /**/---------------------------------------------------------/**/
)
};
